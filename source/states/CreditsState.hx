...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["Melody Engine Contributors"],
			["BobbyDX_",		"bobby",	"Did everything for Melody Engine",							"https://gamebanana.com/members/3384454",	"FFdd33"],
			["GoodieBag",			"goodie",			"Extra Stickers Creator",						"https://gamebanana.com/members/1904855",			"14967B"],
			["jarekboho",			"",					"Coded Lil' Buddies for Psych 1.0",						"https://gamebanana.com/members/2145650",			"14967B"],
			[""],
			['P-Slice Engine Team'],
